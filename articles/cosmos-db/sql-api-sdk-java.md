...
### <a name="2.4.4"/>2.4.4
* Optimized partition key range meta data cache refreshes.

### <a name="2.4.2"/>2.4.2
* Optimized collection cache refreshes.

### <a name="2.4.1"/>2.4.1
* Retrieving inner exception message from request diagnostic string.
...
### <a name="2.2.2"/>2.2.2
* Socket connection improvement, added SoKeepAlive default true.
